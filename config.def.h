...
static Key keys[] = {
    ...
    // resize clients
    {  MOD1,            XK_h,           resizeclient,       {.d = .01, .r = &resizeclientleft}},
    {  MOD1,            XK_l,           resizeclient,       {.d = .01, .r = &resizeclientright}},
    {  MOD1,            XK_j,           resizeclient,       {.d = .01, .r = &resizeclientbottom}},
    {  MOD1,            XK_k,           resizeclient,       {.d = .01, .r = &resizeclienttop}},
